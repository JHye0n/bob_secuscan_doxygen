...
\begin{center}
\leavevmode
\includegraphics[width=234pt]{d1/daf/html__report_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{dd/dbe/html__report_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{함수}
...
html\+\_\+report를 생성해서 보고서 결과를 html로 출력할 수 있도록 구현 

html\+\_\+report.\+cpp 파일의 6 번째 라인에서 정의되었습니다.

이 함수를 호출하는 함수들에 대한 그래프입니다.\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=222pt]{d8/dd8/html__report_8h_a202d1a90bd705341eb39c7e744c86516_icgraph}
\end{center}
\end{figure}
